...
const Footer = () => {
  return (
    <footer className='flex justify-between items-center gap-5 flex-wrap p-2 min-h-[100px] bg-red-900 mt-20'>
        ...
        <div className="text-3xl bg-slate-50 p-4">{footerSection.year}</div>
    </footer>
