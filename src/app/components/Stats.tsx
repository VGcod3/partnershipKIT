...
export default function Stats() {
    return (
        <section className="min-h-screen flex flex-col items-center justify-center max-w-6xl px-6 mx-auto gap-8" id='stats'>
            ...
            <p>* у 2021 році через спалах Covid-19 та карантинні обмеження, кількість учасників зменшилась
                *У 2022 році проєкт не відбувся у зв’язку з початком повномасштабної війни.</p>
        </section >
    )
}