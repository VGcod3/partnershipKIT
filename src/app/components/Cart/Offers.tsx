...
const explanation: { Basic: dataItem[], Engineer: dataItem[], Brand: dataItem[] } = {
    Basic: [
        ...
        },
        {
            ...
            details: "Для додаткового ознайомлення студентів з нашими партнерами, ми додамо до сайту BEC Ваше лого. Воно буде розміщене на сайті https://ebec.best-lviv.org.ua"
        },
        {
